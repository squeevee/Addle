    ...
    _presenter(presenter)
{
    ...
    _action_zoomIn->setToolTip(qtTrId("ui.zoom_in.toolTip"));
    ...
    _action_zoomOut->setToolTip(qtTrId("ui.zoom_out.toolTip"));
    ...
    _action_turntableCW->setToolTip(qtTrId("ui.turntable_cw.toolTip"));
    ...
    _action_turntableCCW->setToolTip(qtTrId("ui.turntable_ccw.toolTip"));
    ...
    _action_reset->setToolTip(qtTrId("ui.reset_view.toolTip"));
    ...
    _slider_zoom->setToolTip(qtTrId("ui.set-zoom.toolTip"));
    ...
    _spinBox_zoomPercent->setToolTip(qtTrId("ui.set-zoom.toolTip"));
